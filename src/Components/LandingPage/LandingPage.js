...
function LandingPage() {
    return (
        ...
        <section className="hero vh-100">
            ...
            <div className="hero-content-area pa2 pa0-l pa0-m">
                <h1>Assalamu-alaikum, I'm manzim</h1>
                <h3> {`<>`} Front-end Developer - SQA - Product Photo Editor - FPL Geek {`</>`} </h3>  
                <a href="#about" class="btn">Visit myFolio</a>              
            </div>
        </section>
